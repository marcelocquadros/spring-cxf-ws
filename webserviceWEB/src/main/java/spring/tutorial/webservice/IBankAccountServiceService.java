 ...
 * 2015-06-28T20:08:09.696-03:00
 * Generated source version: 3.1.1
 * 
 */
@WebServiceClient(name = "IBankAccountServiceService", 
                  wsdlLocation = "file:/home/marcelo/git/spring-web-services/webserviceWEB/src/main/resources/IBankAccountService.wsdl",
...
public class IBankAccountServiceService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/home/marcelo/git/spring-web-services/webserviceWEB/src/main/resources/IBankAccountService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(IBankAccountServiceService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/home/marcelo/git/spring-web-services/webserviceWEB/src/main/resources/IBankAccountService.wsdl");
        }
        WSDL_LOCATION = url;
    }
